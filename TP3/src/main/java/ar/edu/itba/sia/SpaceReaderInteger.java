...
public class SpaceReaderInteger {
	public int FIL = 70;
	public int COL = 5;
	
	public int[][] file;
	
	public SpaceReaderInteger() {
		file = new int[FIL][COL];
	}
	
	public SpaceReaderInteger(int fil , int col) {
		file = new int[fil][col];
		FIL = fil;
		COL = col;
	}
	...
	public int [] splitLine(String line) {
		...
		ret = new int[tempArray.length];
		int i = 0;
		for(String str : tempArray) {
			ret[i] = Integer.parseInt(tempArray[i]);
			i++;
		}
		return ret;
	}
